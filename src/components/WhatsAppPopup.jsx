...
import { X, Send, ChevronDown, CheckCircle } from 'lucide-react';
import { api } from '../api';
...
export default function WhatsAppPopup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await api.submitEnquiry({ ...form, source: 'whatsapp_popup' });
      setSubmitted(true);
    } catch (err) {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => { setSubmitted(false); setError(''); setForm({ name: '', phone: '', plotSize: '', message: '' }); }, 300);
  };
          ...
          >
            ...
            {submitted ? (
              <div className="p-8 flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <h3 className="text-white font-black text-lg mb-1" style={{ fontFamily: 'Playfair Display, serif' }}>
                    Enquiry Submitted!
                  </h3>
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-black tracking-wider uppercase bg-[#25D366] hover:bg-[#1ebe57] text-white transition-colors shadow-lg shadow-[#25D366]/25"
                >
              ...
              <form onSubmit={handleSubmit} noValidate className="p-5 flex flex-col gap-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-gold w-full py-3 rounded-xl text-sm font-black tracking-widest uppercase
